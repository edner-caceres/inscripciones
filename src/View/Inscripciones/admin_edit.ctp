...
<?php echo $this->Form->create('Inscripcion');?>
	<fieldset>
		<legend><?php echo __('Admin Edit Inscripcion'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Inscripcion.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Inscripcion.id'))); ?></li>
