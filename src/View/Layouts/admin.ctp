...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <?php
            ...
            echo $this->Html->css('http://localhost/libs/ext-4.0.7-gpl/resources/css/ext-all.css', 'stylesheet', $opciones);
            echo $this->Html->script('http://localhost/libs/ext-4.0.7-gpl/ext-debug.js', $opciones);
