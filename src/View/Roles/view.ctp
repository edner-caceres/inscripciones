...
<div class="related">
	...
	<tr>
		...
		<th><?php echo __('Fecha Inicio Validez'); ?></th>
		<th><?php echo __('Fecha Fin Validez'); ?></th>
	...
	<?php
		...
		<tr>
			...
			<td><?php echo $cuenta['nombre_de_usuario'];?></td>
			<td><?php echo $cuenta['password'];?></td>
			<td><?php echo $cuenta['fecha_inicio_validez'];?></td>
			<td><?php echo $cuenta['fecha_fin_validez'];?></td>
			<td class="actions">
